...
let homework5 = {
    ...
    print(airTemperatureDict.keys)
    print(airTemperatureDict.values)
    
    print(womensChildren.keys)
    print(womensChildren.values)
    ...
    foreignDict.updateValue("Audi", forKey: "иномарка")
